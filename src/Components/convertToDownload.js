const inlineStyles = (target,background) => {
...
const toImg = async (target,background, name, { scale = 1, format = 'png', quality = 0.92, download = true, ignore = null } = {}) => {
    ...
    inlineStyles(target,background, ignore);
